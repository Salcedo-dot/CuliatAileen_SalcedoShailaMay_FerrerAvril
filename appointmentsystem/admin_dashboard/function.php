...
if (isset($_POST['status']) && isset($_POST['app_id'])) {
    // Retrieve the appointment ID and status (accepted or rejected)
    $app_id = $_POST['app_id'];
    $status = $_POST['status'];  // status will be 'accepted' or 'rejected'
    ...
    // Get PDO connection (assuming a function to get PDO)
